...
public class BTPosition<E> {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof BTPosition) {
			BTPosition<E> p = (BTPosition) obj;
			return (element != null && element.equals(p.getElement())) && (left != null && left.equals(p.left)) && (right != null && right.equals(p.right));
		}
