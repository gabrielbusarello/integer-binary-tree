...
public class LinkedBinaryTreeTests {
	...
	public void removeUmNodo() {
		...
		Integer a =  tree.remove(root.getLeft());
		assertEquals("Remove um nodo com nenhum filho .", new Integer(8)	, a);
		assertEquals("Tamanho da arvore.", 2	, tree.size());

		Integer x =  tree.remove(tree.root());
		assertEquals("Remove a raiz da arvore .", new Integer(10)	,x);
